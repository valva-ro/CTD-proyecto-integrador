...
const config = {
  ...
  initialMessages: [
    ...
    createChatBotMessage(
      "Hola, soy Marco! y a partir de este momento seré tu asistente virtual"
    ) /*Saludo de bienvenida de Marco*/,
    ...
    /*Camino al link del tutorial*/
    {
      ...
      props: {
        options: [
          {
            text: "Ver tutorial",
            url: "https://drive.google.com/file/d/1Fq1S6sNnUanrru8Z-b0e3O8yGh7C2m7u/view?usp=sharing", //aca va el link del tutorial
            id: 1,
          },
        ],
      },
